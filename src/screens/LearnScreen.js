    ...
    try {
      ...
      const updatedAlphabetLessons = alphabetLessons.map((lesson, index) => {
        const lessonProgress = progress.find(
          (p) => p.category === "lessons" && p.item_id === lesson.id,
        );
        ...
        if (index > 0) {
          ...
          const previousProgress = progress.find(
            (p) => p.category === "lessons" && p.item_id === previousLessonId,
          );

          isUnlocked =
            previousProgress && previousProgress.score >= lesson.requiredScore;
        }
        ...
        >
          <View style={styles.authGateContent}>
            ...
            <Text style={styles.authGateMessage}>
              Crea una cuenta o inicia sesión para acceder a nuestras lecciones
              interactivas, seguir tu progreso y ganar logros mientras dominas
    ...
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.tabSwitcher}>
        ...
        <TouchableOpacity
          style={[
            styles.tabButton,
            activeTab === "dataset" && styles.tabButtonActive,
          ]}
          ...
          >
              ...
              >
                ...
                <View style={styles.categoryContent}>
                  ...
                  <Text style={styles.categorySubtitle}>
                    {
                      lessons
                        .slice(0, alphabetLessons.length)
                        .filter((l) => l.completed).length
                    }
                    /{alphabetLessons.length} lecciones completadas
                  </Text>
                </View>
              ...
              >
                ...
                <View style={styles.categoryContent}>
                  ...
                  <Text style={styles.categorySubtitle}>
                    {
                      lessons
                        .slice(alphabetLessons.length)
                        .filter((l) => l.completed).length
                    }
                    /{numberLessons.length} lecciones completadas
                  </Text>
                </View>
                <View style={styles.categoryArrow}>
                  <Icon
            ...
            <View style={styles.sectionHeader}>
              ...
              <Text style={styles.sectionSubtitle}>
                Aprende palabras completas con video
              </Text>
            </View>
        ...
        >
          {isLoading ? (
            ...
            <View style={styles.datasetContainer}>
              ...
              <Text style={styles.sectionSubtitle}>
                Descubre todas las palabras y señas disponibles organizadas por
                categorías
              </Text>
